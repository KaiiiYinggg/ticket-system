...
if (isset($_SESSION['student_id'])) {
    ...
    $sql = "SELECT event_title, price FROM event";
	...
	<div id="formLayout">
		<div id="form-container">
			<form action="process.php" method="POST">
				...
				<input type="number" name="qty" id="qty" min="1" max="8" placeholder="Maximum 8 tickets only"
					onchange="showTicketPrice()" required />
